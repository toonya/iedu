...
// ! certification
// ----------------------------------------
function iedu_certification() {
  $default = array(
		'name' => '英语认证',
		'slug' => 'iedu_certification'
	);
  ...
  $args = array(
	...
	//Provide a callback function that will be called when setting up the meta boxes for the edit form. Do remove_meta_box() and add_meta_box() calls in the callback.
	  'register_meta_box_cb' => 'add_certification_metaboxs',
...
// ----------------------------------------
function add_certification_metaboxs() {

  $screens = array( 'iedu_certification' );
  ...
  foreach ( $screens as $screen ) {
    ...
    add_meta_box(
      'info',
      '详细信息',
      'certification_meta_box_callback',
      $screen,
      'normal',
      'core'
    );
...
$certification_meta_fields = array(
  array(
    'label' => '地址',
    'desc'  => '',
    'id'  => $certification_prefix.'location',
    'type'  => 'text'
  ),
  array(
    'label' => '教学系统',
    'desc'  => '',
    'id'  => $certification_prefix.'edu_sys',
    'type'  => 'text'
  ),
  array(
    'label' => '课程介绍',
    'desc'  => '',
    'id'  => $certification_prefix.'course_intro',
    'type'  => 'textarea'
  ),
  array(
    'label' => '学费',
    'desc'  => '',
    'id'  => $certification_prefix.'fee',
    'type'  => 'text'
  ),
  array(
    'label' => '教学&详情',
    'desc'  => '',
    'id'  => $certification_prefix.'edu_info',
    'type'  => 'textarea'
  ),
  array(
    'label' => '入学&要求',
    'desc'  => '',
    'id'  => $certification_prefix.'requirement',
    'type'  => 'textarea'
  ),
  array(
    'label' => '费用&条款',
    'desc'  => '',
    'id'  => $certification_prefix.'fee_agreement',
    'type'  => 'textarea'
  ),
  array(
    'label' => '服务流程',
    'desc'  => '',
    'id'  => $certification_prefix.'service_process',
    'type'  => 'textarea'
  ),
  array(
    'label' => '申请表格',
    'desc'  => '',
    'id'  => $certification_prefix.'apply_form',
    'type'  => 'textarea'
  ),
);
 ...
 */
function certification_meta_box_callback( $post ) {
  global $certification_meta_fields;
  // Add an nonce field so we can check for it later.
  wp_nonce_field( 'certification_meta_box', 'certification_meta_box_nonce' );
  ...
  foreach ($certification_meta_fields as $field) {
 ...
 */
function certification_save_meta_box_data( $post_id ) {
  global $certification_meta_fields;
  /*
  ...
  if ( ! isset( $_POST['certification_meta_box_nonce'] ) ) {
    return;
  }

  // Verify that the nonce is valid.
  if ( ! wp_verify_nonce( $_POST['certification_meta_box_nonce'], 'certification_meta_box' ) ) {
    return;
  }
  ...
  //update_post_meta( $post_id, 'certification', $my_data );
}
add_action( 'save_post', 'certification_save_meta_box_data' );
