...
<div class="primary custom-single <?php echo get_post_type(); ?>">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<?php  
			...
			$meta_name = array('location', 'time', 'fee', 'num_of_people', 'num_of_school', 'visit_detail', 'fee_agreement', 'service_process', 'apply_form', 'topic_background');
