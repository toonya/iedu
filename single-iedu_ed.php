...
<div class="primary custom-single <?php echo get_post_type(); ?>">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<?php  
			...
			$meta_name = array('location', 'ed_lang', 'course_intro', 'fee', 'edu_info', 'requirement', 'fee_agreement', 'service_process', 'apply_form', 'student_num', 'ed_application-time', 'ed_class-hour');
